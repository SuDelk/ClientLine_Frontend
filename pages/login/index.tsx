...
const Login: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col transition-colors duration-300 pt-20 ${theme === "dark" ? "bg-black" : "bg-gray-50"}
      }`}
    >
      <Header page="login" />
      ...
      <main className="flex-1 flex flex-col lg:flex-row lg:gap-24">
        ...
        <div className="flex-1 flex items-center justify-center lg:justify-end lg:pr-12 px-4 sm:px-6 py-8 lg:py-12">
          <div
            className={`w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8 border p-6 sm:p-8 rounded-xl shadow-lg ${theme === "dark" ? "bg-[#00A857]/30 border-gray-700" : "bg-white border-gray-200"}`}
          >
        ...
        {/* Mobile Image */}
        <div className="lg:hidden flex items-center justify-center px-4 py-6">
          <Image
            src="/Login.png"
            alt="Login"
            width={300}
